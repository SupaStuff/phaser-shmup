...
function Swipe(game, model) {
  ...
  self.DIRECTION_UP = 1;          //0001
  self.DIRECTION_DOWN = 2;        //0010
  self.DIRECTION_LEFT = 4;        //0100
  self.DIRECTION_RIGHT = 8;       //1000
  self.DIRECTION_UP_RIGHT = 9;    //1001
  self.DIRECTION_UP_LEFT = 5;     //0101
  self.DIRECTION_DOWN_RIGHT = 10; //1010
  self.DIRECTION_DOWN_LEFT = 6;   //0110
...
Swipe.prototype.setupKeyboard = function() {
  ...
  up.onHoldCallback = this.keyHeld;
  up.onHoldContext = this;
  ...
  down.onHoldCallback = this.keyHeld;
  down.onHoldContext = this;
  ...
  left.onHoldCallback = this.keyHeld;
  left.onHoldContext = this;
  ...
  right.onHoldCallback = this.keyHeld;
  right.onHoldContext = this;
  right.onUp.add(this.keyUp, this);
}

Swipe.prototype.keyHeld = function() {this.direction = this.tmpDirection;}
